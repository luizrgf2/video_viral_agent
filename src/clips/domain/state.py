...
class ClipExtractionState(BaseModel):
    ...
    transcription: Optional[str] = Field(None, description="Whisper-generated full transcription")
    transcriptionSegments: Optional[List[dict]] = Field(None, description="Transcription segments with timestamps")
